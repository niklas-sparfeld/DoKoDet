...
| [0035 — Backend terminal logging](3-in-progress/0035-Backend_Terminal_Logging.md) | None | Show concise backend business events at `INFO`, warnings and failures at their proper levels, and opt-in `DEBUG` business-process traces in the local terminal. M0–M2 complete; M3 pending. |
