...
| [0066 — Card-state change interval annotation](3-in-progress/0066-Card_State_Change_Interval_Annotation.md) | 0049, 0062, and 0064 complete | M0–M2 complete: interval semantics, stable-end anchoring, fixtures, preservation checks, CardEvent viewer interval editing, range-aware Timeline Rail rendering, bound navigation, and desktop/narrow browser coverage are in place. M3 remains next. |
