...
| [0046 — Filesystem storage engine](3-in-progress/0046-Filesystem_Storage_Engine.md) | None | M0 complete: filesystem ownership inventory and tested path-safe atomic storage primitives; M1–M4 remain. |
