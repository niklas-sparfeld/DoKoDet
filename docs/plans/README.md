...
| Epic | Depends on | Outcome |
| --- | --- | --- |
| [0072 — Pose-based visible-card review](3-in-progress/0072-Pose_Based_Visible_Card_Review.md) | 0048 and 0049 complete | M0–M2 complete: shared calibrated card-plane geometry and versioned scene contracts are frozen; M1 mines deterministic isolated-card candidates and stores immutable calibration revisions; M2 initializes fixed-size poses, suggestion diagnostics, and deterministic stacking order. M3–M5 not started. |
