...
| [0071 — Coarse-to-fine visible-card detection](3-in-progress/0071-Coarse_to_Fine_Visible_Card_Detection.md) | 0048 pipeline data and execution, 0049 recording pipeline review, and the 0068 reviewed RF-DETR training corpus, checkpoint, provider, and evaluation boundaries | M0–M1 complete: one 0068 bundle is reused for the development two-pass cascade, with deterministic padded crops, source-linked mapping, duplicate reconciliation, latency, and partial-stage diagnostics. M2–M6 not started. |
