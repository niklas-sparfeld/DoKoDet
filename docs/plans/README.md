...
| Epic | Depends on | Outcome |
| --- | --- | --- |
| [0074 — Unified visible-card review workbench](3-in-progress/0074-Unified_Visible_Card_Review_Workbench.md) | Completed 0049, 0054, 0065, and 0073 | M0–M1 complete. Shared state and the read-only layered Camera/Rectified review surface are in place; M2–M5 remain. |
