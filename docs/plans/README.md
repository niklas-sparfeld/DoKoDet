...
| [0082 — Fine-model full-frame prepass for visible-card detection](3-in-progress/0082-Fine_Model_Visible_Card_Prepass.md) | Completed 0048, 0049, 0068, and the 0071 fine-stage model and crop contracts; 0071 coarse stage is the removal target | M0–M2 complete: contract and fixtures are frozen, the shared fine-prepass provider is implemented, and the coarse implementation and active controls are removed. M3 is next. |
