...
| Epic | Depends on | Outcome |
| --- | --- | --- |
| [0075 — Robust automatic table-plane calibration](3-in-progress/0075-Robust_Automatic_Table_Plane_Calibration.md) | Completed 0072 and 0073 | M0–M2 complete: the joint boundary fit passes identifiable synthetic and runtime gates. Uniform 10% shrink is unidentifiable without independent size evidence, so its absolute-size gate remains pending. M3–M5 not started. Real-data outline acceptance is pending. |
