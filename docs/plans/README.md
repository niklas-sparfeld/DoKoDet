...
| [0062 — Canonical card-state data and face-down identity](3-in-progress/0062-Canonical_Card_State_and_Face_Down_Identity.md) | 0061 complete | M0 is complete: active annotations, fixture values, current event references, and selections are canonical, with immutable history and an idempotent receipt. M1–M4 remain not started. |
