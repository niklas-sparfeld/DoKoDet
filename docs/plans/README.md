...
| Epic | Depends on | Outcome |
| --- | --- | --- |
| [0075 — Robust automatic table-plane calibration](3-in-progress/0075-Robust_Automatic_Table_Plane_Calibration.md) | Completed 0072 and 0073 | M0–M3 complete: held-out boundary scoring retains a digest-bound fit candidate on failure. Nine of ten known-geometry cases pass; uniform 10% shrink fails absolute-size validation. All 24 frozen local results retain candidates but cannot publish without independent full-card outlines. M4–M5 not started. |
