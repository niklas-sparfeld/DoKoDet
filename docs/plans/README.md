...
| Epic | Depends on | Outcome |
| --- | --- | --- |
| [0072 — Pose-based visible-card review](3-in-progress/0072-Pose_Based_Visible_Card_Review.md) | 0048 and 0049 complete | M0 complete: shared calibrated card-plane geometry and versioned scene contracts are frozen and covered by focused tests. M1–M5 not started. |
