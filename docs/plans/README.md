...
| Epic | Depends on | Outcome |
| --- | --- | --- |
| [0074 — Unified visible-card review workbench](3-in-progress/0074-Unified_Visible_Card_Review_Workbench.md) | Completed 0049, 0054, 0065, and 0073 | M0–M2 complete. Shared state, layered Camera/Rectified review, and visible-region/ignore-region editing are in place; M3–M5 remain. |
