...
| Epic | Depends on | Outcome |
| --- | --- | --- |
| [0064 — CardEvent frame-review editor](3-in-progress/0064-CardEvent_Frame_Review_Editor.md) | 0049, 0054, and 0062 complete | M0–M1 complete: the reviewed CardEvent editor uses the recording-owned exact source-frame surface and compact left review controls with shortcut pills. M2 remains. |
