...
| Epic | Depends on | Outcome |
| --- | --- | --- |
| [0049 — Recording pipeline review and comparison](3-in-progress/0049-Recording_Pipeline_Review_and_Comparison.md) | 0048 complete | Reuse the editors with one maintained reference per stage, simple input selection, retained results, and comparison. M0–M5 complete; M6–M10 not started. |
