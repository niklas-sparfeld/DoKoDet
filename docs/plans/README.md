...
| [0036 — iOS recording workspace simplification](3-in-progress/0036-iOS_Recording_UI_Simplification.md) | 0032 (complete) | Replace the separate Live and Record flows with one profile-based recording workspace and keep the existing durable upload and analysis lifecycle. M0 complete. |
